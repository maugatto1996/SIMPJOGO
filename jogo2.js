...
function preload() {
    game.load.image('sky', 'assets/usina.png');
	game.load.image('ground', 'assets/platform.png');
	game.load.image('blocks', 'assets/nuclear2.jpg');
	game.load.spritesheet('jogador', 'assets/dude.png', 32, 48);
	game.load.image('star', 'assets/roscaa.png');
...
function create() {
	...
	ledge = platforms.create(480, 100, 'blocks');
	...
	ledge = platforms.create(700, 200, 'blocks');
    ledge.body.immovable = true;
	
	ledge = platforms.create(400, 420, 'blocks');
    ledge.body.immovable = true;
	
	ledge = platforms.create(50, 500, 'blocks');
    ledge.body.immovable = true;
	
	
	ledge = platforms.create(100, 400, 'blocks');
    ledge.body.immovable = true;
	
	ledge = platforms.create(50, 180, 'blocks');
    ledge.body.immovable = true;
	
		ledge = platforms.create(200, 300, 'blocks');
    ledge.body.immovable = true;
